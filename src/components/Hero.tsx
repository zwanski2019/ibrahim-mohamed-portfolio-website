      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className={`mb-12 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h1 className="text-display-1 font-bold mb-8 bg-gradient-to-r from-blue-300 via-emerald-300 to-blue-400 bg-clip-text text-transparent leading-tight will-change-transform">
              {t("hero.headline")}
            </h1>
            <h2 className="text-heading-1 text-emerald-300 mb-8 font-serif font-semibold tracking-wide">
              {t("hero.subheadline")}
            </h2>
          </div>
          ...
          <div className={`mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-body-large text-slate-300 max-w-5xl mx-auto leading-relaxed">
              {t("hero.description")}
            </p>
          </div>
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center mb-20 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <Link to="/chat" aria-label={t("hero.cta3")}>
              <Button size="lg" className="group h-16 px-10 text-xl bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-700 hover:to-emerald-600 shadow-elevation-3 hover:shadow-elevation-4 transition-all duration-300 transform hover:scale-105 will-change-transform">
                {t("hero.cta3")}
