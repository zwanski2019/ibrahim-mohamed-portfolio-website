              ...
              <div className="absolute inset-0 bg-gradient-to-br from-secondary/30 to-secondary/10 rounded-2xl border border-border overflow-hidden">
                <picture>
                  <source
                    ...
                    srcSet={`${heroImage}?w=400&format=webp 400w, ${heroImage}?w=600&format=webp 600w`}
                    sizes="(max-width: 768px) 400px, 600px"
                    type="image/webp"
                  />
                  <source
                    media="(min-width: 769px)"
                    srcSet={`${heroImage}?w=600&format=webp 600w, ${heroImage}?w=800&format=webp 800w`}
                    sizes="(min-width: 769px) 600px, 800px"
                    type="image/webp"
                  />
                  <img 
                    src={heroImage}
